...
CREATE TABLE `rolesuser` (
  ...
  KEY `FK8bx6j1bgakleobbleo57hp9i` (`user_id`),
  CONSTRAINT `FK3iq6mcaacupyhooxyu6luxdy0` FOREIGN KEY (`role_id`) REFERENCES `roles` (`role_id`),
  CONSTRAINT `FK8bx6j1bgakleobbleo57hp9i` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
