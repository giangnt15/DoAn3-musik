...
CREATE TABLE `author_song` (
  ...
  KEY `FKik9ag2jk7vk1cjoesc2286gun` (`song_id`),
  CONSTRAINT `FKik9ag2jk7vk1cjoesc2286gun` FOREIGN KEY (`song_id`) REFERENCES `song` (`song_id`),
  CONSTRAINT `FKpi1dy4b8832pm4dtpttm65smb` FOREIGN KEY (`author_id`) REFERENCES `author` (`author_id`)
