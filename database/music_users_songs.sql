...
CREATE TABLE `users_songs` (
  ...
  UNIQUE KEY `UK_g9ypynlal9kf5xremvmsis04j` (`songs_song_id`),
  CONSTRAINT `FK4iepouu51bqn5638r2jdvwe6n` FOREIGN KEY (`user_user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `FKj15jhneiti9h6s7rb16rjueli` FOREIGN KEY (`songs_song_id`) REFERENCES `song` (`song_id`)
